module.exports = {
    ...
    ignorePatterns: ["dist", ".eslintrc.cjs", "vite.config.ts", "commitlint.config.cjs", "src/api/generated/**", "cypress/**", "cypress.config.cjs"], // Don't lint build output or node_modules
